...
fig.suptitle('Problem 3 | Cost of updating the PV forecast',x=.075,y=.985,ha='left',fontsize=17)
...
ax[0].text(.02,.80,'Feb-Dec totals: '+ ' / '.join(f'{v:.3f}' for v in totals)+' million CNY',transform=ax[0].transAxes,fontsize=10,color='#555555')
