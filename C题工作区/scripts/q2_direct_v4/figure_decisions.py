...
for name,ident,title,reason,layout,changes in [
    ('savings','cmp_gradient_single_factor_bar','渐变单因子条形图','Three matched horizontal-bar panels show all eight policies and positive/negative bill differences without conflating additive components.',
