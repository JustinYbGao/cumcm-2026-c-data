...
ROOT = WORK / 'reports/q2_pareto_v3/figures'
os.environ['TMPDIR'] = str(WORK / 'results/q2_pareto_v3/runtime/plotting')
os.environ['MPLCONFIGDIR'] = str(WORK / 'results/q2_pareto_v3/runtime/plotting/matplotlib')
...
def adapt(name):
    ...
    code = (WORK/'scripts/q2_pareto_v3/plots'/f'{name}.py').read_text()
