...
ROOT = WORK / 'reports/q2_cost_aware_v2/figures'
os.environ['TMPDIR'] = str(WORK / 'results/q2_cost_aware_v2/runtime/plotting')
os.environ['MPLCONFIGDIR'] = str(WORK / 'results/q2_cost_aware_v2/runtime/plotting/matplotlib')
...
def adapt(name):
    ...
    code = (WORK/'scripts/q2_cost_aware_v2/plots'/f'{name}.py').read_text()
