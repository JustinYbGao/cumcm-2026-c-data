...
ROOT = WORK / 'reports/emergency_improvement_v1/figures'
os.environ['TMPDIR'] = str(WORK / 'results/emergency_improvement_v1/runtime/plotting')
os.environ['MPLCONFIGDIR'] = str(WORK / 'results/emergency_improvement_v1/runtime/plotting/matplotlib')
...
def adapt(name):
    ...
    code = (WORK/'scripts/emergency_improvement_v1/plots'/f'{name}.py').read_text()
